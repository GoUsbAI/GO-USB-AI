...
export const browserAuthCopy: Record<BrowserAuthLocale, BrowserAuthCopyTree> = {
  "zh-CN": {
    meta: {
      htmlTitle: "GoUsbAi Account 设备授权",
      platformTag: "GoUsbAi Platform",
      accountTag: "GoUsbAi Account",
      languageLabel: "语言",
      languageNames: {
        "zh-CN": "中文",
        "en-US": "English",
    ...
    hero: {
      title: "登录 GoUsbAi Account，把设备和网页入口接到同一套体验里。",
      description:
        "一个 GoUsbAi Account，把本地设备、网页入口、远程访问和后续协作能力连成一条连续路径。登录之后，你的实例、分享和账号能力都会在这里汇合。",
      highlights: {
        account: {
          title: "一个账号，连接所有入口",
          description:
            "桌面端、网页端和后续账号能力共享同一个 GoUsbAi Account，不需要维护两套身份。",
        },
        workflow: {
    ...
    heading: {
      pending: {
        title: "连接这台 GoUsbAi 设备",
        subtitle: "登录 GoUsbAi Account，授权当前本地设备接入网页与远程能力。",
      },
      authorized: {
        title: "设备已授权",
        subtitle: "可以回到 GoUsbAi 继续使用了，这个浏览器页面现在可以关闭。",
      },
      expired: {
        title: "授权已过期",
        subtitle: "这个授权会话已经失效，请回到 GoUsbAi 重新发起一次授权。",
      },
      missing: {
        title: "授权不存在",
        subtitle: "当前设备授权请求已经失效或不存在，请回到 GoUsbAi 重新开始。",
      },
    },
    modes: {
      login: {
        label: "登录",
        title: "邮箱 + 密码登录",
        subtitle: "已有 GoUsbAi Account 可直接登录。注册和找回密码在旁边两个入口。",
        sectionLabel: "登录",
        sectionCopy:
          "使用你的 GoUsbAi Account 邮箱和密码登录。新注册账号需要先完成邮箱验证码验证。",
      },
      register: {
        label: "注册",
        title: "先验证邮箱，再设置密码",
    ...
    notices: {
      success: {
        ...
        deviceLinked: "这台设备已经成功绑定到你的 GoUsbAi Account。",
  ...
  "en-US": {
    meta: {
      htmlTitle: "GoUsbAi Account Device Authorization",
      platformTag: "GoUsbAi Platform",
      accountTag: "GoUsbAi Account",
    ...
    hero: {
      title: "Sign in to GoUsbAi Account and connect this device to the same web experience.",
      description:
        "One GoUsbAi Account brings together local devices, web entry, remote access, and future collaboration into a single flow. Once you sign in, your instances, shares, and account capabilities all meet here.",
      highlights: {
        account: {
          title: "One account across every entry point",
          description:
            "Desktop, web, and future account capabilities all use the same GoUsbAi Account, so you do not have to manage separate identities.",
        },
        workflow: {
    ...
    heading: {
      pending: {
        title: "Connect this GoUsbAi device",
        subtitle: "Sign in to your GoUsbAi Account and authorize this local device for web and remote capabilities.",
      },
      authorized: {
        title: "Device authorized",
        subtitle: "Return to GoUsbAi to continue. This browser page can be closed now.",
      },
      expired: {
        title: "Authorization expired",
        subtitle: "This authorization session has expired. Return to GoUsbAi and start it again.",
      },
      missing: {
        title: "Authorization not found",
        subtitle: "This authorization request is no longer valid. Return to GoUsbAi and start again.",
      },
    },
    modes: {
      login: {
        ...
        subtitle: "Use your existing GoUsbAi Account password to sign in. Registration and password reset are in the other tabs.",
        sectionLabel: "Sign in",
        sectionCopy: "Use your GoUsbAi Account email and password. New accounts must verify email ownership before registration completes.",
      },
      register: {
        label: "Sign up",
    ...
    notices: {
      success: {
        ...
        deviceLinked: "This device is now linked to your GoUsbAi Account.",
