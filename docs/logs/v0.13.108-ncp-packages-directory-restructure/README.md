...
- 更新根脚本中的 NCP 包路径：
  ...
  - `lint`
  - `tsc`
- 更新 `docker/Dockerfile` 中对 `@go-usb-ai/ncp` 的构建路径
...
- `pnpm -C packages/ncp-packages/go-usb-ai-ncp-http-agent-server build`
- `pnpm -C packages/ncp-packages/go-usb-ai-ncp-http-agent-server test`
...
- `pnpm -C packages/ncp-packages/go-usb-ai-ncp-http-agent-client test`
