...
- 将项目英文 README 的社群二维码从微信群切换为 QQ 群图，素材改为 [`images/contact/go-usb-ai-contact-qq-group.jpg`](../../../images/contact/go-usb-ai-contact-qq-group.jpg)。
...
- 重新部署 landing，当前本次 Pages 预览地址为 `https://0647a4ca.go-usb-ai-landing.pages.dev`。
...
- 本地冒烟：
  ...
  - `curl -I http://127.0.0.1:4173/contact/go-usb-ai-contact-qq-group.jpg`
  - `rg -n "go-usb-ai-contact-qq-group|QQ Group|QQ群" apps/landing/dist`
- 线上冒烟：
  - `curl -I https://0647a4ca.go-usb-ai-landing.pages.dev/contact/go-usb-ai-contact-qq-group.jpg`
- 可维护性守卫：
...
- Wrangler 返回：`https://0647a4ca.go-usb-ai-landing.pages.dev`
...
3. 打开 `https://go-usb-ai.io/en/` 或本次 Pages 预览地址，确认社区按钮、弹窗、页脚指向的都是 QQ 群图片。
4. 打开 `https://go-usb-ai.io/zh/` 或本次 Pages 预览地址，确认中文文案显示为“QQ群/加入QQ群/QQ群二维码”。
