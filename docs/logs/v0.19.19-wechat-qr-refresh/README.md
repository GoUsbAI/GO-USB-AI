...
- 将 GitHub README 使用的微信群二维码资产更新为 2026-05-23 新图：`images/contact/go-usb-ai-contact-wechat-group.png`。
- 将官网二维码资产更新为 2026-05-23 新图，并把 landing 源码中的社群二维码入口切到 `/contact/go-usb-ai-contact-wechat-group-2026-05-23.png`。
- 同步更新官网通用二维码资产：`apps/landing/public/contact/go-usb-ai-contact-wechat-group.png`。
...
- 本地 Playwright 冒烟：`http://127.0.0.1:4173/zh/` 页面与弹窗均加载 `/contact/go-usb-ai-contact-wechat-group-2026-05-23.png`，图片尺寸 `1207 x 1732`。
...
- 本次部署预览地址：`https://01c84282.go-usb-ai-landing.pages.dev`。
- 线上官网 `https://go-usb-ai.io/zh/` 已通过 Playwright 验证加载新二维码。

## 用户/产品视角的验收步骤

1. 打开 `https://go-usb-ai.io/zh/`。
2. 滚动到社群区域，或点击页面中的微信群入口。
3. 确认页面展示和弹窗中的二维码均为 2026-05-23 新二维码。
4. 打开 GitHub README，确认社群二维码引用 `images/contact/go-usb-ai-contact-wechat-group.png`，该资产已替换为新图。
