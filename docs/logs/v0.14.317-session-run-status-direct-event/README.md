...
- `PATH=/Users/peiwang/.nvm/versions/node/v22.16.0/bin:$PATH pnpm --filter @go-usb-ai/ncp-toolkit exec vitest run src/agent/agent-backend-run-status.test.ts src/agent/agent-backend-finalize-status.test.ts src/agent/in-memory-agent-backend.test.ts src/agent/agent-conversation-state-manager.test.ts`
- `PATH=/Users/peiwang/.nvm/versions/node/v22.16.0/bin:$PATH pnpm --filter go-usb-ai-ui exec vitest run src/api/ncp-session-query-cache.test.ts`
