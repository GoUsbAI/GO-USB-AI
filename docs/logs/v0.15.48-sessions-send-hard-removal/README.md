...
- 同步清理当前产品面文档与设计说明，包括 [`docs/USAGE.md`](../../USAGE.md)、[`packages/go-usb-ai/resources/USAGE.md`](../../../packages/go-usb-ai/resources/USAGE.md)、[`docs/prd/current-feature-list.md`](../../prd/current-feature-list.md)、[`docs/feature-universe.md`](../../feature-universe.md)、`apps/docs` 的多 Agent 指南以及当前多 Agent 设计参考；包内 `ui-dist` 也已重建，不再携带旧 UI 文案。本次方案记录见 [`2026-04-08-sessions-send-removal-plan.md`](../../plans/2026-04-08-sessions-send-removal-plan.md)。
...
- 文档同步：
  - `PATH=/opt/homebrew/bin:$PATH node packages/go-usb-ai/scripts/sync-usage-resource.mjs`
- 包内 UI 产物同步：
  - `PATH=/opt/homebrew/bin:$PATH pnpm -C packages/go-usb-ai-ui build`
  - `PATH=/opt/homebrew/bin:$PATH node packages/go-usb-ai/scripts/copy-ui-dist.mjs`
- 单测：
  - `PATH=/opt/homebrew/bin:$PATH pnpm -C packages/go-usb-ai-core exec vitest run src/agent/tests/context.test.ts src/agent/tests/loop.tool-catalog.test.ts src/agent/tools/sessions-list.test.ts`
- 类型检查：
...
- 定向 ESLint：
  - `PATH=/opt/homebrew/bin:$PATH pnpm exec eslint packages/go-usb-ai-core/src/agent/context.ts packages/go-usb-ai-core/src/agent/loop.ts packages/go-usb-ai-core/src/agent/tests/context.test.ts packages/go-usb-ai-core/src/agent/tools/sessions.ts packages/go-usb-ai-core/src/agent/tools/sessions-list.test.ts packages/go-usb-ai-core/src/agent/tools/tool-catalog.utils.ts packages/go-usb-ai-core/src/config/schema.help.ts packages/go-usb-ai-core/src/config/schema.labels.ts packages/go-usb-ai-core/src/config/schema.ts packages/go-usb-ai-server/src/ui/config.ts packages/go-usb-ai-server/src/ui/types.ts packages/go-usb-ai-ui/src/api/types.ts packages/go-usb-ai-ui/src/components/config/RuntimeConfig.tsx packages/go-usb-ai-ui/src/lib/i18n.ts packages/go-usb-ai/src/cli/commands/ncp/go-usb-ai-ncp-tool-registry.ts packages/go-usb-ai/src/cli/commands/plugin/plugin-command-utils.ts`
...
- 目录结构与文件组织是否满足当前项目治理要求：本次没有新增目录问题，但 `packages/go-usb-ai-core/src/agent/loop.ts`、`packages/go-usb-ai-server/src/ui/config.ts`、`packages/go-usb-ai-ui/src/components/config/RuntimeConfig.tsx` 等历史热点仍超预算；本次已在上方记录减债与下一步拆分缝，未单独展开更大范围拆分以免偏离主任务。
