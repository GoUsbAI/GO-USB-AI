...
Stable desktop release aligned to GoUsbAi `0.18.5`.
...
- Unified npm release batch is now published on the public registry, including `go-usb-ai@0.18.5` and `@go-usb-ai/ui@0.12.13`.
...
**Full Changelog**: https://github.com/Peiiii/go-usb-ai/compare/v0.18.0-desktop.1...v0.18.5-desktop.1

## 中文版

这是与 GoUsbAi `0.18.5` 对齐的桌面正式稳定版。
...
- 统一 NPM 发版批次已经发布到官方 registry，包括 `go-usb-ai@0.18.5` 与 `@go-usb-ai/ui@0.12.13`。
...
**完整变更**: https://github.com/Peiiii/go-usb-ai/compare/v0.18.0-desktop.1...v0.18.5-desktop.1
