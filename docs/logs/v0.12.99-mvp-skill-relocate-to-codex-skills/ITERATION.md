...
- 将 `mvp-view-logic-decoupling` 从内置技能目录迁移到项目根目录 `.codex/skills`：
  - 迁移前：`packages/go-usb-ai-core/src/agent/skills/mvp-view-logic-decoupling`
  - 迁移后：`.codex/skills/mvp-view-logic-decoupling`
- 清理内置技能索引中的误加条目：
  - `packages/go-usb-ai-core/src/agent/skills/README.md` 删除 `mvp-view-logic-decoupling` 索引行。
