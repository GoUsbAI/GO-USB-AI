...
```bash
node .agents/skills/post-edit-maintainability-guard/scripts/check-maintainability.mjs --paths packages/go-usb-ai-server/src/ui/router/ncp-session.controller.ts packages/go-usb-ai-server/src/ui/types.ts packages/go-usb-ai-ui/src/api/ncp-session-query-cache.ts packages/go-usb-ai-ui/src/api/ncp-session-query-cache.test.ts packages/go-usb-ai-ui/src/components/chat/ChatSidebar.tsx packages/go-usb-ai-ui/src/components/chat/ChatSidebar.test.tsx packages/go-usb-ai-ui/src/components/chat/chat-session-label.service.ts packages/go-usb-ai-ui/src/components/chat/managers/chat-session-list.manager.ts packages/go-usb-ai-ui/src/components/chat/ncp/NcpChatPage.tsx packages/go-usb-ai-ui/src/components/chat/ncp/ncp-chat-thread.manager.ts packages/go-usb-ai-ui/src/components/chat/ncp/ncp-chat.presenter.ts packages/go-usb-ai-ui/src/components/chat/ncp/ncp-session-adapter.ts packages/go-usb-ai-ui/src/components/chat/ncp/ncp-session-adapter.test.ts packages/go-usb-ai-ui/src/components/chat/ncp/use-ncp-session-list-view.ts packages/go-usb-ai-ui/src/components/chat/presenter/chat-presenter-context.tsx packages/go-usb-ai-ui/src/components/chat/stores/chat-session-list.store.ts packages/go-usb-ai-ui/src/hooks/use-realtime-query-bridge.ts packages/go-usb-ai-ui/src/hooks/useConfig.ts packages/go-usb-ai/src/cli/commands/ncp/create-ui-ncp-agent.ts packages/go-usb-ai/src/cli/commands/ncp/ui-session-service.ts packages/go-usb-ai/src/cli/commands/ncp/ncp-session-summary.ts packages/go-usb-ai/src/cli/commands/ncp/ncp-session-realtime-change.ts packages/go-usb-ai/src/cli/commands/ncp/ncp-session-realtime-change.test.ts packages/go-usb-ai/src/cli/commands/service-deferred-ncp-agent.test.ts packages/go-usb-ai/src/cli/commands/service-deferred-ncp-session-service.ts packages/go-usb-ai/src/cli/commands/service-deferred-ncp-session-service.test.ts packages/go-usb-ai/src/cli/commands/service-gateway-startup.ts packages/go-usb-ai/src/cli/commands/service-ncp-session-realtime-bridge.ts packages/go-usb-ai/src/cli/commands/service.ts
```
