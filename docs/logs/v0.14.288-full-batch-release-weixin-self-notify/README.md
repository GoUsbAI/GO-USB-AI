...
- 新增 GoUsbAi 内置 AI skill：[cross-channel-messaging](../../../packages/go-usb-ai-core/src/agent/skills/cross-channel-messaging/SKILL.md)，让 AI 在“当前回复 / `sessions_send` / `message`”之间做正确选择。
