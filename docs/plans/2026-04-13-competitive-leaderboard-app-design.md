...
在 `apps/competitive-leaderboard` 落成一个“龙虾类产品研究榜单”应用，但它不是 GoUsbAi 的单向宣传页，而是一个长期可更新、以公开证据为核心的研究型索引站。

这个方向与 [GoUsbAi 产品愿景](../VISION.md) 对齐的地方在于：

- 它服务的是“统一入口与能力编排”的外部解释框架，而不是继续往主产品里塞功能。
- 它帮助用户理解“个人 AI 操作层”这一产品形态，而不是只看单个功能点。
- 它让 GoUsbAi 以被评对象身份出现，而不是预设结论的营销主角。
