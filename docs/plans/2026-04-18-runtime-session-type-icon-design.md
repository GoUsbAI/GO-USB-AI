...
GoUsbAi 已经支持多种 agent runtime / session type，但“新会话”选择器、侧边栏会话上下文与当前会话头部仍主要依赖纯文本 label。
...
runtime icon 不是孤立特性。它属于 GoUsbAi 的 Resource URI 体系，统一规范见 [2026-04-18-resource-uri-conventions.md](/Users/peiwang/Projects/nextbot/docs/designs/2026-04-18-resource-uri-conventions.md)。
...
- 统一入口：不同 runtime 仍然通过同一套会话入口进入 GoUsbAi
...
- `packages/go-usb-ai-ui/public/runtime-icons/`
