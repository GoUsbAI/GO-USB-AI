# GoUsbAi UI Chat Phase 3 Plan

## Goal
- Push `packages/go-usb-ai-ui/src/components/chat` to a clean package-candidate baseline.
...
## Scope
- Separate reusable exports from GoUsbAi host-layer exports.
...
1. Split chat exports into:
   ...
   - go-usb-ai layer: `containers` and GoUsbAi-facing adapters
...
- GoUsbAi host exports are available from a separate entry.
