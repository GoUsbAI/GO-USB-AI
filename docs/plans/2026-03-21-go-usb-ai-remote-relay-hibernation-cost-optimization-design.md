# GoUsbAi Remote Relay Hibernation Cost Optimization Design
...
- connector 仍桥接到本地 GoUsbAi UI / API
...
### 9.1 `workers/go-usb-ai-provider-gateway-api/src/remote-relay-do.ts`
...
### 9.2 `packages/go-usb-ai-remote/src/remote-connector.ts`
...
### 9.3 `workers/go-usb-ai-provider-gateway-api/src/controllers/remote-controller.ts`
...
### 9.4 `workers/go-usb-ai-provider-gateway-api/src/repositories/remote-repository.ts`
...
对于 GoUsbAi 当前的 remote access 模型，最低长期成本方案不是废掉 DO，也不是先付费止血，而是：
