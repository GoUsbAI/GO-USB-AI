...
```bash
go-usb-ai cron add -n "one-shot-wechat" -m 'At the scheduled time, send a WeChat message to the current chat saying: "会议还有 5 分钟开始。"' --at 2035-01-01T10:05:00+08:00
```
