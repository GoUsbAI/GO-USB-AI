    ...
    <div className="page-stack">
      <section className="hero-section">
        <div className="hero-copy">
          <p className="hero-eyebrow">GoUsbAi Apps</p>
          <h1>轻量、可分发、可本地运行的 GoUsbAi 应用形态。</h1>
          <p>
          ...
          <div className="hero-actions">
            ...
            <a className="button-link button-link--ghost" href="https://github.com/Peiiii/go-usb-ai">
              开发者入口
            </a>
          </div>
        </div>
        <div className="hero-panel">
          ...
          <code>npm install -g @go-usb-ai/app-runtime</code>
          <p className="hero-panel__label">Run</p>
          <code>napp install go-usb-ai.hello-notes</code>
        </div>
      </section>
