import { BaseChannel, getDataPath, isTypingStopControlMessage, type Config, type InboundAttachment, type InboundAttachmentErrorCode, type MessageBus, type OutboundMessage, } from "@go-usb-ai/core";
