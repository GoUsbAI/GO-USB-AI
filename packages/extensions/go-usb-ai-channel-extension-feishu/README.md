...
Lightweight Feishu/Lark channel extension for GoUsbAi.

This extension uses the new GoUsbAi extension process model and supports QR
...
4. Credentials are stored under `GOUSB_AI_HOME/channels/feishu`.
