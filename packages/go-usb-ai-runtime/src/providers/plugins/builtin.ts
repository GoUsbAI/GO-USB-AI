import type { ProviderCatalogPlugin } from "@go-usb-ai/core";
  ...
  providers: [
    {
      ...
      displayName: "GoUsbAi Built-in",
      modelPrefix: "go-usb-ai",
      litellmPrefix: "go-usb-ai",
      skipPrefixes: [],
      envExtras: [],
      isGateway: true,
      isLocal: false,
      detectByKeyPrefix: "nc_free_",
      detectByBaseKeyword: "go-usb-ai.io",
    ...
    dashscopeCodingPlanProviderSpec, kimiCodingProviderSpec,
    {
      ...
      auth: {
        ...
        note: {
          zh: "通过浏览器登录 Qwen 后即可在 GoUsbAi 中使用该 Provider。",
          en: "Log in to Qwen in your browser, then use this provider in GoUsbAi."
        }
      }
    },
    {
