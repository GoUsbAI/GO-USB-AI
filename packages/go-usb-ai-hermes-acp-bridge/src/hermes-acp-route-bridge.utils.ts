...
const HERMES_ACP_BRIDGE_ENABLE_ENV = "GOUSB_AI_HERMES_ACP_ROUTE_BRIDGE";
const HERMES_ACP_BRIDGE_DIR_ENV = "GOUSB_AI_HERMES_ACP_ROUTE_BRIDGE_DIR";
const HERMES_ACP_PROBE_ROUTE_ENV = {
  GOUSB_AI_MODEL: "go-usb-ai-hermes-acp-probe",
  GOUSB_AI_API_BASE: "http://127.0.0.1:1/v1",
  GOUSB_AI_API_KEY: "go-usb-ai-hermes-acp-probe-key",
  GOUSB_AI_HEADERS_JSON: JSON.stringify({
