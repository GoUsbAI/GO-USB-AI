...
import type { GoUsbAiClientOptions } from "./types/go-usb-ai-request.types.js";
...
export class GoUsbAiClient {
  ...
  constructor(options: GoUsbAiClientOptions) {
    ...
    let realtimeSubscription: GoUsbAiRealtimeSubscription | null = null;
