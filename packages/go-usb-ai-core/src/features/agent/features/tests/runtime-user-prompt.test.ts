...
function createWorkspace(): string {
  const workspace = mkdtempSync(join(tmpdir(), "go-usb-ai-runtime-user-prompt-test-"));
...
describe("buildBootstrapAwareUserPrompt", () => {
  it("injects workspace context and bootstrap files before the user message", () => {
    ...
    expect(prompt).toContain("Canonical repository: https://github.com/Peiiii/go-usb-ai");
