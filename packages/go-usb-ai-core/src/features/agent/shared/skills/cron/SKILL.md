...
description_zh: 创建和管理提醒、定时任务与周期性自动化，是 GoUsbAi 内置的 cron 调度能力说明。
---
...
```
cron(action="add", name="github-stars", message="Check Peiiii/go-usb-ai GitHub stars and report", every=600)
```
