...
This directory contains built-in skills that extend go-usb-ai's capabilities.
...
| `go-usb-ai-autostart` | Guide GoUsbAi host autostart setup, reboot recovery, and service registration diagnostics |
| `go-usb-ai-skill-resource-hub` | Curate GoUsbAi, OpenClaw, and community skill resources |
