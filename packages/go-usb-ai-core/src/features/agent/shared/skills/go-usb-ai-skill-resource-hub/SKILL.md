---
name: go-usb-ai-skill-resource-hub
description: Curate GoUsbAi skill resources, including OpenClaw and community sources. Use when expanding GoUsbAi skills, planning reuse/adaptation, or building a skill roadmap.
description_zh: 用于整理和评估 GoUsbAi skill 资源，包括 OpenClaw 与社区来源，适合规划 skill 扩展、复用改造和路线图。
metadata: {"go-usb-ai":{"emoji":"🧭"}}
---

# GoUsbAi Skill Resource Hub

Use this skill to discover, assess, and reuse high-signal resources for GoUsbAi skill expansion.

## Source Priority

Read and prioritize sources in this order:

1. GoUsbAi official repositories and docs (highest priority)
...
- `adapt`: identify candidates for adaptation into GoUsbAi built-in skills
...
- Relevance to current GoUsbAi needs
