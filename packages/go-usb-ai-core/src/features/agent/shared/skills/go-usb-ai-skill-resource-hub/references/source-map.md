# GoUsbAi Skill Source Map

## Core Sources

### 1) GoUsbAi Main Repository (official)
- URL: https://github.com/Peiiii/go-usb-ai
- Use for: current project architecture, package boundaries, and skill integration style
- Notes: highest-priority source for GoUsbAi-compatible decisions

### 2) GoUsbAi Docs (official)
- URL: https://docs.go-usb-ai.io/
...
- Notes: evaluate compatibility and license before direct reuse in GoUsbAi

## Suggested Triage Checklist

For each candidate skill/repo, verify:

1. License compatibility with GoUsbAi usage model
2. Maintenance freshness (recent commits/releases)
3. Dependency complexity and runtime fit
4. Reuse type:
- direct reuse
- adapt into GoUsbAi style
- keep as external reference

## Suggested Search Queries

- `go-usb-ai skills github`
- `go-usb-ai skill ecosystem`
