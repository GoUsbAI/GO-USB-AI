...
import { DEFAULT_HOME_DIR, DEFAULT_SKILLS_DIR, DEFAULT_WORKSPACE_DIR, ENV_HOME_KEY, getDefaultWorkspacePath } from "../../../../features/config/configs/brand.js";
...
export function resolveWorkspacePath(workspace?: string): string {
  ...
  if (configured && configured !== getDefaultWorkspacePath()) {
...
export function getPackageVersion(): string {
  ...
  return (
    resolveVersionFromPackageTree(dir, "@go-usb-ai/core") ??
