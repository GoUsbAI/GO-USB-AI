import { NcpEventType, type NcpEndpointEvent, type NcpMessagePart } from "@go-usb-ai/ncp";
import type {
...
import { GoUsbAiExtension } from "./extension-client.service.js";
...
export async function startChannelExtension<TConfig, TInbound>(
  ...
  options: GoUsbAiExtensionOptions = {},
): Promise<void> {
  const extension = new GoUsbAiExtension(options);
