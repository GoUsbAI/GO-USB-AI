...
@keyframes go-usb-ai-chat-typing-text-sheen {
  0% {
...
.go-usb-ai-chat-typing-indicator__text {
  ...
  animation: go-usb-ai-chat-typing-text-sheen 2.5s linear infinite;
}
...
function ChatTypingIndicator({ label }: { label: string }) {
  return (
    <div className="rounded-2xl border border-gray-200 bg-white px-4 py-3 text-sm text-gray-500 shadow-sm">
      ...
      <span className="go-usb-ai-chat-typing-indicator__text">{label}</span>
    </div>
  );
}
