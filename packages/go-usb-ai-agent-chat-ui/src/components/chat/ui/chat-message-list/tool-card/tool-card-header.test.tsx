...
it("keeps the summary in a shrinkable flex lane when header actions are present", () => {
  const { container } = render(
    <ToolCardHeader
      card={{
        kind: "call",
        toolName: "read",
        summary: "path: /Users/peiwang/.go-usb-ai/workspace/skills/bird/SKILL.md",
        hasResult: false,
        statusTone: "success",
  ...
  const summary = screen.getByTitle("/Users/peiwang/.go-usb-ai/workspace/skills/bird/SKILL.md");
