...
describe('ChatSlashMenu', () => {
  ...
  it('renders active item details and forwards selection', () => {
    ...
    const item = {
      ...
      detailLines: ['Spec: workspace:/Users/tongwenwen/.go-usb-ai/workspace/skills/bird']
    };
    ...
    expect(screen.getByText(/workspace:\/Users\/tongwenwen\/\.go-usb-ai\/workspace\/skills\/bird/i).className).toContain('break-all');
