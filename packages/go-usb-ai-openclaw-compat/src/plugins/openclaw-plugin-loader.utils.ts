import { getWorkspacePathFromConfig, type Config } from "@go-usb-ai/core";
...
const STARTUP_TRACE_ENABLED = process.env.GOUSB_AI_STARTUP_TRACE === "1";
...
export function loadOpenClawPlugins(options: PluginLoadOptions): PluginRegistry {
  ...
  const loadExternalPlugins = process.env.GOUSB_AI_ENABLE_OPENCLAW_PLUGINS !== "0";
