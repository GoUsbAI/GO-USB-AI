...
export default defineConfig({
  resolve: {
    alias: {
      ...
      '@go-usb-ai/agent-chat': path.resolve(__dirname, '../go-usb-ai-agent-chat/src/index.ts'),
      '@go-usb-ai/agent-chat-ui': path.resolve(__dirname, '../go-usb-ai-agent-chat-ui/src/index.ts'),
      '@agent-chat-ui': path.resolve(__dirname, '../go-usb-ai-agent-chat-ui/src'),
      '@go-usb-ai/client-sdk': path.resolve(__dirname, '../go-usb-ai-client-sdk/src/index.ts'),
