...
import { startGoUsbAiPwa } from "@/pwa/register-pwa";
...
export default function AppContent() {
  ...
  return (
    <QueryClientProvider client={appQueryClient}>
      ...
      <PwaInstallBanner />
      <PwaUpdateBanner />
      <Toaster position="top-right" richColors offset={window.goUsbAiDesktop?.platform === "win32" ? 56 : undefined} mobileOffset={window.goUsbAiDesktop?.platform === "win32" ? 56 : undefined} />
    </QueryClientProvider>
  );
}
