export const PWA_INSTALL_BANNER_DISMISS_STORAGE_KEY = 'go-usb-ai-pwa-install-banner-dismissed';
export const PWA_INSTALL_BANNER_LEGACY_UNTIL_STORAGE_KEY = 'go-usb-ai-pwa-install-banner-dismissed-until';
