...
function createMarketplaceItem(
  ...
  return {
    ...
    install: {
      ...
      command: "go-usb-ai skills install @go-usb-ai/web-search",
    },
...
function createPluginMarketplaceItem(
  ...
  return createMarketplaceItem({
    ...
    type: "plugin",
    name: "Slack Channel",
    summary: "Optional Slack channel for GoUsbAi",
    summaryI18n: { en: "Optional Slack channel for GoUsbAi" },
    install: {
      kind: "npm",
      spec: "@go-usb-ai/community-plugin-slack",
      command: "npm install @go-usb-ai/community-plugin-slack",
    },
    ...overrides,
  });
}
...
describe("MarketplacePage", () => {
  ...
  it("does not render the redundant plugin type label in plugin cards", () => {
        ...
        items: [
          createMarketplaceItem({
            ...
            install: {
              ...
              spec: "@go-usb-ai/community-plugin-slack",
              command:
                "npm install @go-usb-ai/community-plugin-slack",
            },
          }),
        ],
      } satisfies MarketplaceListView,
    ...
    expect(card?.textContent).toContain(
      "@go-usb-ai/community-plugin-slack",
    );
  ...
  it("only disables the targeted plugin action while a manage request is pending", async () => {
        ...
        items: [
          ...
          createPluginMarketplaceItem({
            ...
            install: {
              ...
              command:
                "npm install @go-usb-ai/community-plugin-discord",
            },
          }),
        ],
      } satisfies MarketplaceListView,
    ...
    mocks.installedQuery = createInstalledQuery({
      data: {
        ...
        specs: [
          "@go-usb-ai/community-plugin-slack",
          "@go-usb-ai/community-plugin-discord",
        ],
        records: [
          createInstalledRecord(),
          createInstalledRecord({
            id: "@go-usb-ai/community-plugin-discord",
            spec: "@go-usb-ai/community-plugin-discord",
