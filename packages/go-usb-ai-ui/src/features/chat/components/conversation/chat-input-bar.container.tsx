...
import { ChatInputBar, type ChatInputBarHandle } from '@go-usb-ai/agent-chat-ui';
import { DEFAULT_NCP_ATTACHMENT_MAX_BYTES, uploadFilesAsNcpDraftAttachments } from '@go-usb-ai/ncp-react';
