...
import type { ChatFileOpenActionViewModel, ChatFileOperationBlockViewModel } from "@go-usb-ai/agent-chat-ui";
import { ChatMessageMarkdown, FileOperationCodeSurface } from "@go-usb-ai/agent-chat-ui";
