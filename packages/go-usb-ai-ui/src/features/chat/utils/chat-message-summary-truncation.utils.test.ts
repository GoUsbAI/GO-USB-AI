import { ToolInvocationStatus, type UiMessage } from "@go-usb-ai/agent-chat";
import { adaptChatMessages } from "./chat-message.utils";
import type { ChatMessageSource } from "./chat-message.utils";
import type { ChatMessagePartViewModel } from "@go-usb-ai/agent-chat-ui";
...
it("truncates long structured tool summaries into a single-line ellipsis detail", () => {
      ...
      parts: [
        {
          ...
          toolInvocation: {
            ...
            args: JSON.stringify({
              command:
                "ls -la /Users/peiwang/.go-usb-ai/workspace/skills/bird/snapshots/archive/releases/2026-04-17/builds/current/output 2>/dev/null | sed -n '1,160p' && echo 'done'",
            }),
          },
        },
      ],
  ...
  expect(summary?.startsWith("command: ls -la /Users/peiwang/.go-usb-ai/workspace/skills/bird/")).toBe(true);
