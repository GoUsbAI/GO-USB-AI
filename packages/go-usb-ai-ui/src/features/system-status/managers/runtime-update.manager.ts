...
import type { GoUsbAiDesktopBridge } from '@/platforms/desktop';
...
class DesktopBridgeRuntimeUpdateSource implements DesktopBridgeRuntimeUpdateSourceContract {
  ...
  constructor(private readonly desktopApi: GoUsbAiDesktopBridge) {}
...
export class RuntimeUpdateManager {
  ...
  private getDesktopApi = (): GoUsbAiDesktopBridge | null => {
    if (typeof window === 'undefined') {
      return null;
    }
    return window.goUsbAiDesktop ?? null;
  };
