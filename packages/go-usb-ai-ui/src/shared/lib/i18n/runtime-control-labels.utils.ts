export const RUNTIME_CONTROL_LABELS: Record<string, { zh: string; en: string }> = {
  ...
  runtimePresenceCloseToBackgroundHelp: {
    zh: '开启后，关闭桌面窗口只会隐藏到托盘，不会停止本地 GoUsbAi 服务。',
    en: 'When enabled, closing the desktop window hides it to the tray instead of stopping the local GoUsbAi service.'
  },
  runtimePresenceLaunchAtLogin: { zh: '登录系统时自动启动 GoUsbAi', en: 'Launch GoUsbAi at login' },
  ...
  runtimePresenceManagedLocalDescription: {
    zh: '关闭浏览器标签页不会停止本地 GoUsbAi 服务。服务生命周期由本地受管服务负责，而不是由页面生命周期决定。',
    en: 'Closing the browser tab does not stop the local GoUsbAi service. The local managed service owns the lifecycle, not the page.'
  },
  ...
  runtimeControlManagedLocalMessage: { zh: '使用此页面管理本地 GoUsbAi 服务。关闭浏览器不会停止服务。', en: 'Use this page to manage the local GoUsbAi service. Closing the browser does not stop the service.' },
  ...
  runtimeControlStartingServiceHelp: {
    zh: '正在启动 GoUsbAi 服务，页面可能会在服务恢复后重新连接。',
    en: 'Starting the GoUsbAi service. The page may reconnect after the service becomes available.'
  },
  runtimeControlRestartingServiceHelp: {
    zh: '正在重启 GoUsbAi 服务，页面可能会短暂断开。',
    en: 'Restarting the GoUsbAi service. The page may disconnect briefly.'
  },
  runtimeControlStoppingServiceHelp: {
    zh: '正在停止 GoUsbAi 服务，当前页面会很快断开。',
    en: 'Stopping the GoUsbAi service. This page will disconnect shortly.'
  },
  ...
  runtimeControlRestartAppConfirm: {
    zh: '这会重启整个 GoUsbAi 桌面应用，并中断当前窗口。确定继续吗？',
    en: 'This restarts the entire GoUsbAi desktop app and interrupts the current window. Continue?'
  },
  runtimeControlStopServiceConfirm: {
    zh: '这会停止当前 GoUsbAi 服务，当前页面会立即断开。确定继续吗？',
    en: 'This stops the current GoUsbAi service and disconnects the page immediately. Continue?'
  },
