export const CHAT_LABELS: Record<string, { zh: string; en: string }> = {
  ...
  chatInputPlaceholderCompact: { zh: '发消息...', en: 'Message GoUsbAi...' },
  ...
  chatSessionProjectDialogDescription: {
    zh: '把当前会话绑定到运行 GoUsbAi 服务的那台机器上的一个目录，让后续消息和工具执行围绕这个目录展开。',
    en: 'Bind this session to a directory on the machine running the GoUsbAi service so future messages and tool runs work around that directory.'
  },
