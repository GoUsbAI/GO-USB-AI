export const PWA_LABELS: Record<string, { zh: string; en: string }> = {
  ...
  pwaInstallDescription: {
    zh: '把当前 GO-USB-AI UI 安装为独立入口，方便从桌面、启动器或任务栏直接打开。',
    en: 'Install this GO-USB-AI UI as a standalone entry point you can launch from your desktop, launcher, or dock.'
  },
  pwaInstallAction: { zh: '安装 GO-USB-AI', en: 'Install GO-USB-AI' },
  pwaInstallDismiss: { zh: '不再提示', en: "Don't Ask Again" },
  pwaInstallAccepted: { zh: '已打开安装面板。', en: 'Install prompt opened.' },
  pwaInstalledToast: { zh: 'GO-USB-AI 已安装为应用入口。', en: 'GO-USB-AI is now installed as an app.' },
  ...
  pwaInstallCardPrompt: {
    zh: '当前浏览器已经准备好安装面板。安装后，GO-USB-AI 会以独立窗口形态打开，但仍沿用同一套 Web UI 和运行时连接逻辑。',
    en: 'Your browser is ready to install GO-USB-AI. Once installed, it opens in a standalone window while keeping the same Web UI and runtime behavior.'
  },
  pwaInstallCardManual: {
    zh: '当前环境支持把 GO-USB-AI 安装为应用，但浏览器没有提供即时安装弹窗。你仍可通过浏览器菜单中的“安装应用”或“添加到主屏幕”完成安装。',
    en: 'This environment can install GO-USB-AI as an app, but the browser did not expose an immediate install prompt. Use your browser menu to install or add it to the home screen.'
  },
  pwaInstallCardInstalled: {
    zh: '当前已经以应用形态运行。浏览器访问与已安装形态共用同一套 GO-USB-AI UI，不会分叉成第二套产品逻辑。',
    en: 'GO-USB-AI is already running as an installed app. Browser access and the installed experience share the same UI and product behavior.'
  },
  ...
  pwaInstallPromptHint: {
    zh: '安装后仍然连接当前本地或远端 GO-USB-AI 服务，不会额外生成一套离线副本。',
    en: 'The installed app still connects to the same local or remote GO-USB-AI service instead of creating an offline copy.'
  },
  ...
  pwaInstallBannerTitle: { zh: '把 GO-USB-AI 固定成桌面入口', en: 'Pin GO-USB-AI as an App' },
  pwaInstallBannerDescription: {
    zh: '当前站点已经满足安装条件。安装后你可以像打开普通应用一样直接进入 GO-USB-AI。',
    en: 'This site is ready to install. Once installed, you can launch GO-USB-AI like a regular app.'
  },
  pwaUpdateBannerTitle: { zh: 'GO-USB-AI 已准备好更新', en: 'GO-USB-AI Update Ready' },
