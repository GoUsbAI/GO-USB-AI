export const DESKTOP_UPDATE_LABELS: Record<string, { zh: string; en: string }> = {
  ...
  desktopUpdatesDesktopOnlyDescription: {
    zh: '这个页面暂时只在 GoUsbAi Desktop 中可用。',
    en: 'This page is currently only available inside GoUsbAi Desktop.'
  },
  ...
  'desktopUpdatesBlockedRootCause.host-too-old': { zh: '根因：当前宿主版本太旧，不满足新运行包的最低宿主版本要求；请先升级 GoUsbAi 启动器。', en: 'Root cause: the host is too old for this runtime bundle; upgrade the GoUsbAi launcher first.' },
