export const AGENT_LABELS: Record<string, { zh: string; en: string }> = {
  ...
  agentsCreateDialogHint: {
    zh: '如果你希望让 AI 自动完成全部自定义，也可以继续使用 `go-usb-ai agents new`。',
    en: 'If you want AI to automate the full setup, you can still use `go-usb-ai agents new`.'
  },
  agentsCreateTitle: { zh: '创建 Agent', en: 'Create Agent' },
  agentsCreateDescription: {
    zh: '这里提供轻量入口。完整自动化创建链路也可通过 `go-usb-ai agents new` 使用。',
    en: 'This is the lightweight UI entry. The full automation path is also available through `go-usb-ai agents new`.'
  },
