export const REMOTE_LABELS: Record<string, { zh: string; en: string }> = {
  ...
  remotePageDescription: {
    zh: '让这台设备出现在 GoUsbAi Platform 的设备列表里，并从网页中打开它。',
    en: 'Make this device appear in your GoUsbAi Platform device list and open it from the web.'
  },
  remoteOpenWeb: { zh: '前往 GoUsbAi Web', en: 'Open GoUsbAi Web' },
  remoteOpenDeviceList: { zh: '前往 GoUsbAi Web', en: 'Open GoUsbAi Web' },
  remoteOpenWebHint: {
    zh: '开启后，这台设备会出现在 GoUsbAi Web 中，你可以在那里点击打开并继续使用。',
    en: 'Once enabled, this device appears in GoUsbAi Web, where you can open it and keep working.'
  },
  ...
  remoteStatusNeedsSignIn: { zh: '先登录 GoUsbAi', en: 'Sign in to GoUsbAi first' },
  remoteStatusNeedsSignInDescription: {
    zh: '远程访问依赖 GoUsbAi 账号。登录后，这台设备才能和网页版关联起来。',
    en: 'Remote access depends on your GoUsbAi account. Sign in first to link this device to the web app.'
  },
  remoteStatusNeedsEnable: { zh: '还没有开启远程访问', en: 'Remote access is not enabled yet' },
  remoteStatusNeedsEnableDescription: {
    zh: '你已经登录 GoUsbAi。开启后，这台设备会出现在网页版的设备列表中。',
    en: 'You are already signed in. Enable remote access and this device will appear in your web device list.'
  },
  remoteStatusConnectingTitle: { zh: '正在把这台设备接入 GoUsbAi Web', en: 'Connecting this device to GoUsbAi Web' },
  ...
  remoteStatusReadyDescription: {
    zh: '你现在可以前往 GoUsbAi Web，在设备列表中点击打开，继续这条 Agent 链路。',
    en: 'You can now open GoUsbAi Web, find this device in the list, and continue your agent workflow there.'
  },
  ...
  remoteStatusReauthorizationTitle: { zh: '登录已过期，请重新登录 GoUsbAi', en: 'Your sign-in expired. Sign in to GoUsbAi again.' },
  ...
  remoteEnabledReady: { zh: '远程访问已开启，现在可以前往 GoUsbAi Web 使用', en: 'Remote access is enabled. You can now use GoUsbAi Web.' },
  ...
  remoteAccountEntryTitle: { zh: 'GoUsbAi 账号', en: 'GoUsbAi Account' },
  remoteAccountEntryDisconnected: { zh: '未登录，点击连接', en: 'Not signed in. Click to connect.' },
  remoteAccountEntryConnected: { zh: '已连接到 GoUsbAi', en: 'Connected to GoUsbAi' },
  remoteAccountEntryManage: { zh: '账号', en: 'Account' },
  accountPanelTitle: { zh: 'GoUsbAi 账号', en: 'GoUsbAi Account' },
  ...
  accountPanelSignedInDescription: {
    zh: '这台设备已经和你的 GoUsbAi 账号关联，可以直接去网页版查看设备。',
    en: 'This device is linked to your GoUsbAi account. You can go to the web app and open the device there.'
  },
  accountPanelSignedOutTitle: { zh: '通过浏览器完成登录', en: 'Continue Sign-In in Your Browser' },
  accountPanelSignedOutDescription: {
    zh: '点击下方按钮后会打开 GoUsbAi 网页，在网页中登录或注册，当前设备会自动接入。',
    en: 'Click the button below to open GoUsbAi Web, sign in or create an account there, and this device will attach automatically.'
  },
  ...
  remotePlatformApiBaseHelp: {
    zh: '留空可回退到登录时写入的 providers.go-usb-ai.apiBase。',
    en: 'Leave empty to fall back to providers.go-usb-ai.apiBase saved at login time.'
  },
  ...
  remoteAccountDescription: {
    zh: '通过浏览器授权把当前设备安全连接到 GoUsbAi 平台。',
    en: 'Authorize this device in your browser and connect it to the GoUsbAi platform.'
  },
