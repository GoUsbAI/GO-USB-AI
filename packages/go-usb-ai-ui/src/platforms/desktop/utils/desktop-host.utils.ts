...
const devPlatformOverrideParam = "goUsbAiDesktopPlatform";
const devPlatformOverrideStorageKey = "go-usb-ai.desktopPlatformOverride";

export function getDesktopHostPlatform(): DesktopHostPlatform {
  if (typeof window === "undefined") {
    return null;
  }
  return getDevDesktopHostPlatformOverride() ?? window.goUsbAiDesktop?.platform ?? null;
}
