...
export function registerSkillsCommands(program: Command, gousb: GoUsbAiServiceRuntime): void {
  const skillsCommands = gousb.commands.skills;
  ...
  skills
    ...
    .description("Install a skill from GoUsbAi marketplace")
  ...
  skills
    ...
    .option("--scope <scope>", "Package scope, for example alice or go-usb-ai")
    ...
    .option("--api-base <url>", "Marketplace API base URL")
    .option("--token <token>", "Marketplace admin token for official @go-usb-ai/* publishing")
