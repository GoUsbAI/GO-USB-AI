...
5. For GoUsbAi self-management tasks (version/status/doctor/service/plugins/channels/config/agents/cron/remote/update), read the built-in GoUsbAi self-management guide path from the system prompt first
