...
import type { PluginChannelBinding, PluginUiMetadata } from "@go-usb-ai/openclaw-compat";
import type { UiAuthService } from "@go-usb-ai-server/features/auth/index.js";
import type {
  BootstrapStatusView,
...
import type { RuntimeControlActionResult, RuntimeControlView } from "@go-usb-ai-server/features/runtime-control/index.js";
...
export type UiRouterOptions = {
  ...
  uiConfig?: Pick<GoUsbAiCore.Config["ui"], "enabled" | "host" | "open" | "port">;
