...
import { applySessionPreferencePatch } from "@go-usb-ai-server/features/sessions/utils/session-preference-patch.utils.js";
import {
  isSessionProjectRootValidationError,
  normalizeSessionProjectRoot,
} from "@go-usb-ai-server/features/sessions/utils/session-project-root.utils.js";
import { SessionSkillsViewBuilder } from "@go-usb-ai-server/features/sessions/services/session-skills-view.service.js";
