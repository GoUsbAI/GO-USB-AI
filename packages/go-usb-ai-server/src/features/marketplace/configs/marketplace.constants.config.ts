export const DEFAULT_MARKETPLACE_API_BASE = "https://marketplace-api.go-usb-ai.io";
...
export const MARKETPLACE_ZH_COPY_BY_SLUG: Record<string, { summary: string; description?: string }> = {
  weather: {
    summary: "GoUsbAi 内置技能，用于天气查询工作流。",
    description: "在 GoUsbAi 中提供快速天气查询工作流。"
  },
  summarize: {
    summary: "GoUsbAi 内置技能，用于结构化摘要。",
    description: "在 GoUsbAi 中提供文件与长文本的摘要工作流。"
  },
  github: {
    summary: "GoUsbAi 内置技能，用于 GitHub 工作流。",
    description: "在 GoUsbAi 中提供 Issue、PR 与仓库相关工作流指引。"
  },
  tmux: {
    summary: "GoUsbAi 内置技能，用于终端/Tmux 协作工作流。",
    description: "在 GoUsbAi 中提供基于 Tmux 的任务执行工作流指引。"
  },
  gog: {
    summary: "GoUsbAi 内置技能，用于图谱导向生成工作流。",
    description: "在 GoUsbAi 中提供图谱与规划导向工作流指引。"
  },
  pdf: {
  ...
  "channel-plugin-clawbay": {
    summary: "Clawbay 官方渠道插件，用于 GoUsbAi 集成。",
    description: "通过插件运行时为 GoUsbAi 提供 Clawbay 渠道能力。"
  }
};
