import type { Config, ConfigUiHints } from "@go-usb-ai/core";
import { mergePluginConfigView, toPluginConfigView, type PluginChannelBinding, type PluginUiMetadata } from "@go-usb-ai/openclaw-compat";
import type { ConfigMetaView } from "@go-usb-ai-server/shared/types/server-api.types.js";
...
const DOCS_BASE_URL = "https://docs.go-usb-ai.io";
const CHANNEL_TUTORIAL_URLS: Record<string, ChannelTutorialUrls> = {
  ...
  weixin: {
    default: "https://npmx.dev/package/@go-usb-ai/channel-extension-weixin"
  }
};
