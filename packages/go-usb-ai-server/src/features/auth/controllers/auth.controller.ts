...
import { ensureUiBridgeSecret } from "@go-usb-ai-server/features/auth/utils/auth-bridge.utils.js";
import type {
...
export class AuthRoutesController {
  ...
  readonly issueBridgeSession = (c: Context) => {
    const providedSecret = c.req.header("x-go-usb-ai-ui-bridge-secret")?.trim();
