...
const DEFAULT_TASK_NAME = "GoUsbAi Host Autostart";
...
export class WindowsTaskAutostartService {
  ...
  private buildPlan = () => {
    ...
    const resourcePath = windowsPath.resolve(homeDir, "autostart", "go-usb-ai-host-autostart.cmd");
  ...
  private renderLauncher = (params: {
    ...
    return [
      "@echo off",
      "setlocal",
      `set "GOUSB_AI_HOME=${this.escapeBatchValue(homeDir)}"`,
