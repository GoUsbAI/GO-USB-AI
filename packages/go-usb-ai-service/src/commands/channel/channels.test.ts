...
describe("ChannelCommands.status", () => {
  ...
  it("lists GoUsbAi extension manifest channels without starting extension processes", () => {
    mocks.getPluginChannelBindingsMock.mockReturnValue([]);
  ...
  it("prints plugin channels as structured JSON for agent channel discovery", () => {
    mocks.getPluginChannelBindingsMock.mockReturnValue([
      ...
      {
        pluginId: "go-usb-ai-channel-extension-feishu",
        channelId: "feishu",
        channel: {
          id: "feishu",
          meta: { label: "Feishu" },
