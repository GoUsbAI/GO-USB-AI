...
import { readCurrentGoUsbAiRemoteRuntimeState } from "./remote-runtime-support.utils.js";

describe("readCurrentGoUsbAiRemoteRuntimeState", () => {
  afterEach(() => {
    vi.restoreAllMocks();
  });
  ...
  it("downgrades stale managed service runtime from connected to disconnected", () => {
    ...
    const state = readCurrentGoUsbAiRemoteRuntimeState();
