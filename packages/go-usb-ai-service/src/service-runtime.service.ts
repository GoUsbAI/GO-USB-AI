import { loadConfig, saveConfig, getConfigPath, getDataDir, resolveWorkspacePath, resolveConfigSecrets, APP_NAME } from "@go-usb-ai/core";
import { GoUsbAiKernel } from "@go-usb-ai/kernel";
import { RemoteRuntimeActions } from "@go-usb-ai/remote";
import {
  setPluginRuntimeBridge,
} from "@go-usb-ai/openclaw-compat";
import { existsSync, mkdirSync } from "node:fs";
import { spawn } from "node:child_process";
import { RestartCoordinator } from "@go-usb-ai-service/shared/services/restart/restart-coordinator.service.js";
import type { RestartStrategy } from "@go-usb-ai-service/shared/services/restart/restart-coordinator.service.js";
import { initializeConfigIfMissing } from "@go-usb-ai-service/shared/services/runtime/runtime-config-init.service.js";
import { writeRestartSentinel } from "@go-usb-ai-service/shared/services/restart/restart-sentinel.service.js";
import { createTopLevelGoUsbAiCommandEnv } from "@go-usb-ai-service/shared/utils/top-level-go-usb-ai-command-env.utils.js";
import { resolveCliSubcommandLaunch } from "@go-usb-ai-service/shared/utils/marketplace/cli-subcommand-launch.utils.js";
import { logStartupTrace, measureStartupSync } from "@go-usb-ai-service/shared/utils/startup-trace.js";
import { isProcessRunning } from "@go-usb-ai-service/shared/utils/cli.utils.js";
import { NpmRuntimeUpdateCommandService } from "@go-usb-ai-service/launcher/npm-runtime-update-command.service.js";
import { NpmRuntimeLauncher } from "@go-usb-ai-service/launcher/npm-runtime-launcher.service.js";
import { managedServiceStateStore } from "@go-usb-ai-service/shared/stores/managed-service-state.store.js";
import { mergePluginConfigView, toPluginConfigView, PluginCommands } from "@go-usb-ai-service/commands/plugin/index.js";
import { ConfigCommands } from "@go-usb-ai-service/cli/commands/config/index.js";
import { McpCommands } from "@go-usb-ai-service/cli/commands/mcp/index.js";
import { SecretsCommands } from "@go-usb-ai-service/cli/commands/secrets/index.js";
import { ChannelCommands } from "@go-usb-ai-service/commands/channel/index.js";
import { CronCommands } from "@go-usb-ai-service/cli/commands/cron/index.js";
import { AgentCommands, runCliAgentCommand } from "@go-usb-ai-service/cli/commands/agent/index.js";
import { PlatformAuthCommands } from "@go-usb-ai-service/commands/platform-auth/index.js";
import { RemoteCommands, hasRunningGoUsbAiManagedService } from "@go-usb-ai-service/commands/remote/index.js";
import { DiagnosticsCommands } from "@go-usb-ai-service/cli/commands/diagnostics/index.js";
import { LogsCommands } from "@go-usb-ai-service/cli/commands/logs/index.js";
import { RuntimeCommandService } from "@go-usb-ai-service/shared/services/runtime/runtime-command.service.js";
import { GoUsbAiDistributionService } from "@go-usb-ai-service/shared/services/runtime/go-usb-ai-distribution.service.js";
import { ServiceCommands } from "@go-usb-ai-service/commands/service/index.js";
import { WorkspaceManager } from "@go-usb-ai-service/shared/services/workspace/workspace-manager.service.js";
import { RuntimeRestartRequestService } from "@go-usb-ai-service/shared/services/restart/runtime-restart-request.service.js";
import { SkillsCommands } from "@go-usb-ai-service/cli/commands/skills/index.js";
import { GatewayCommands } from "@go-usb-ai-service/cli/commands/gateway/index.js";
import { UiCommands } from "@go-usb-ai-service/cli/commands/ui/index.js";
import { StartCommands } from "@go-usb-ai-service/cli/commands/start/index.js";
import { RestartCommands } from "@go-usb-ai-service/cli/commands/restart/index.js";
import { ServeCommands } from "@go-usb-ai-service/cli/commands/serve/index.js";
import { StopCommands } from "@go-usb-ai-service/cli/commands/stop/index.js";
import { LlmUsageCommandService } from "@go-usb-ai-service/cli/commands/usage/index.js";
import type { AgentCommandOptions, LoginCommandOptions, RequestRestartParams, UpdateCommandOptions } from "@go-usb-ai-service/shared/types/cli.types.js";
const FORCED_PUBLIC_UI_HOST = "0.0.0.0";

export type GoUsbAiServiceRuntimeOptions = {
  logo?: string;
};

export type GoUsbAiServiceRuntimeAccount = {
...
export type GoUsbAiServiceCommands = {
...
export class GoUsbAiServiceRuntime {
  private logo: string;
  ...
  account: GoUsbAiServiceRuntimeAccount;
  commands: GoUsbAiServiceCommands;
  constructor(options: GoUsbAiServiceRuntimeOptions) {
  ...
  private createCommands = (): GoUsbAiServiceCommands => {
    ...
    return {
      remote: measureStartupSync("cli.runtime.remote_runtime_actions", () => new RemoteRuntimeActions({
        ...
        hasRunningManagedService: hasRunningGoUsbAiManagedService
      })),
  ...
  get version(): string {
    return GoUsbAiDistributionService.get().version;
  }
  ...
  private armManagedServiceRelaunch = (params: {
    ...
    try {
      const helper = spawn(process.execPath, ["-e", helperScript], {
        detached: true,
        stdio: "ignore",
        env: createTopLevelGoUsbAiCommandEnv(process.env),
        windowsHide: true
      });
      helper.unref();
  ...
  private writeRestartSentinelFromExecContext = async (reason: string): Promise<void> => {
    const sessionKeyRaw = process.env.GOUSB_AI_RUNTIME_SESSION_KEY;
    const sessionKey =
  ...
  agent = async (opts: AgentCommandOptions): Promise<void> => {
    const configPath = getConfigPath();
    const kernel = new GoUsbAiKernel({
      homeDir: getDataDir(),
      configPath,
    });
  ...
  update = async (opts: UpdateCommandOptions): Promise<void> => {
    ...
    if (!opts.json) {
      const installationLabel = process.env.GOUSB_AI_DESKTOP_COMMAND_SURFACE === "1" ? "desktop runtime" : "npm launcher";
...
export const runGoUsbAiNpmRuntimeLauncher = (
  argv: string[] = process.argv,
): void => {
  const distribution = GoUsbAiDistributionService.get();
