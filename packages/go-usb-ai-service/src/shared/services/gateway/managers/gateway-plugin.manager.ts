...
import { logPluginDiagnostics } from "@go-usb-ai-service/commands/plugin/index.js";
import {
  logPluginGatewayDiagnostics,
  pluginGatewayLogger,
} from "@go-usb-ai-service/shared/services/gateway/service-startup-support.service.js";
