import { loadConfig, saveConfig, type InboundAttachment } from "@go-usb-ai/core";
import { setPluginRuntimeBridge } from "@go-usb-ai/openclaw-compat";
import { dispatchPromptOverNcp } from "@go-usb-ai/kernel";
...
export function installPluginRuntimeBridge(gateway: GoUsbAiGatewayRuntime): void {
