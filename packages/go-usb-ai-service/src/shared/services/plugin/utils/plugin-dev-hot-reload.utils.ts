...
import type { ServiceFileWatcherRegistry } from "@go-usb-ai-service/shared/services/gateway/service-startup-support.service.js";

export const DEV_PLUGIN_HOT_RELOAD_TARGETS_ENV = "GOUSB_AI_DEV_PLUGIN_HOT_RELOAD_TARGETS";
