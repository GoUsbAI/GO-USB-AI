...
import { APP_NAME, DEFAULT_SKILLS_DIR, getDataDir } from "@go-usb-ai/core";
import { findExecutableOnPath } from "@go-usb-ai-service/shared/utils/cli.utils.js";
...
export class WorkspaceManager {
  ...
  private readonly resolveTemplateDir = (): string | null => {
    const override = process.env.GOUSB_AI_TEMPLATE_DIR?.trim();
    if (override) {
      return override;
    }
