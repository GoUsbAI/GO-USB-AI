...
vi.mock("@go-usb-ai-service/commands/remote/services/remote-service-control.service.js", () => ({
...
describe("RuntimeControlHost", () => {
  ...
  it("exposes pending restart reasons without auto-restarting", () => {
    ...
    expect(view.message).toBe("Use this page to manage the local GoUsbAi service. Closing the browser does not stop the service.");
  });
