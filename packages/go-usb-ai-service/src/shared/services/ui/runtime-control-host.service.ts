...
import type { RuntimeControlActionResult, RuntimeControlView, UiRuntimeControlHost } from "@go-usb-ai/server";
import { requestManagedServiceRestart } from "@go-usb-ai-service/shared/services/ui/service-remote-access.service.js";
import { controlRemoteService, resolveRemoteServiceView } from "@go-usb-ai-service/commands/remote/services/remote-service-control.service.js";
import type { RequestRestartParams } from "@go-usb-ai-service/shared/types/cli.types.js";
import { pendingRestartStore } from "@go-usb-ai-service/shared/stores/pending-restart.store.js";
  ...
  getControl = (): RuntimeControlView => {
    ...
    return {
      ...
      managementHint: service.currentProcess
        ...
        : "Manage the local GoUsbAi service from this page without tying service lifecycle to the browser tab.",
      message: "Use this page to manage the local GoUsbAi service. Closing the browser does not stop the service."
    };
  };
