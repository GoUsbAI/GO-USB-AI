...
import { FileLogSink } from "@go-usb-ai/core";
import {
...
import { writeInitialManagedServiceState, writeReadyManagedServiceState } from "@go-usb-ai-service/shared/services/runtime/utils/service-remote-runtime.utils.js";
import type { ManagedServiceSnapshot } from "@go-usb-ai-service/shared/services/runtime/utils/managed-service-routing.utils.js";
...
import { isProcessRunning, resolveServiceLogPath } from "@go-usb-ai-service/shared/utils/cli.utils.js";
...
export class ManagedServiceSupervisor {
  ...
  private readonly serviceStartupLogger = GoUsbAiCore.getAppLogger("service.startup");
