...
import { getPackageVersion as getCorePackageVersion } from "@go-usb-ai/core";
...
export function getPackageVersion(importMetaUrl = import.meta.url): string {
  ...
  const packageVersion =
    findNearestPackageVersion(cliDir, "go-usb-ai") ??
    findWorkspacePackageVersion(cliDir, "go-usb-ai") ??
