import { APP_NAME, loadConfig } from "@go-usb-ai/core";
...
import { findListeningProcessByPort, isProcessRunning, resolveUiConfig, waitForExit } from "@go-usb-ai-service/shared/utils/cli.utils.js";
import { resolveManagedServiceUiOverrides } from "@go-usb-ai-service/shared/utils/runtime-helpers.js";
import { describeUnmanagedHealthyTargetMessage } from "@go-usb-ai-service/shared/services/runtime/runtime-command.service.js";
...
import type { StartCommands } from "@go-usb-ai-service/cli/commands/start/index.js";
...
export class RestartCommands {
  ...
  private resolveAdoptableForegroundRuntimePid = (port: number): number | null => {
    ...
    return this.isAdoptableGoUsbAiRuntimeCommand(listeningProcess.command) ? listeningProcess.pid : null;
  };

  private isAdoptableGoUsbAiRuntimeCommand = (command: string | null): boolean => {
