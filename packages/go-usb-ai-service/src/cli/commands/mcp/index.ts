import { loadConfig, saveConfig, type McpServerDefinition } from "@go-usb-ai/core";
import {
  McpDoctorFacade,
  McpMutationService,
  McpRegistryService
} from "@go-usb-ai/mcp";
import type { McpAddCommandOptions, McpDoctorOptions, McpListOptions } from "@go-usb-ai-service/shared/types/cli.types.js";
