import { getLoggingRuntime, type AppLogKind, type LoggingRuntime } from "@go-usb-ai/core";
import type { LogsTailCommandOptions } from "@go-usb-ai-service/shared/types/cli.types.js";
