...
import { listBuiltinProviders } from "@go-usb-ai/runtime";
import { isProcessRunning, resolveUiApiBase, resolveUiConfig } from "@go-usb-ai-service/shared/utils/cli.utils.js";
import { managedServiceStateStore } from "@go-usb-ai-service/shared/stores/managed-service-state.store.js";
import type { ManagedServiceState } from "@go-usb-ai-service/shared/stores/managed-service-state.store.js";
...
import { resolveGoUsbAiRemoteStatusSnapshot } from "@go-usb-ai-service/commands/remote/index.js";
import type { DoctorCommandOptions, HealthProbe, RuntimeStatusReport, StatusCommandOptions } from "@go-usb-ai-service/shared/types/cli.types.js";
...
export class DiagnosticsCommands {
  ...
  private readonly collectRuntimeStatus = async (params: { verbose: boolean; fix: boolean }): Promise<RuntimeStatusReport> => {
    ...
    const remote = resolveGoUsbAiRemoteStatusSnapshot(config);
