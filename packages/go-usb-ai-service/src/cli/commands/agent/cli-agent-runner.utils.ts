...
import type { AgentCommandOptions } from "@go-usb-ai-service/shared/types/cli.types.js";
import { printAgentResponse, prompt } from "@go-usb-ai-service/shared/utils/cli.utils.js";
...
async function runCliInteractiveLoop(params: {
  logo: string;
  config: Config;
  agentRunRequests: GoUsbAiKernel["agentRunRequestManager"];
  sessionKey: string;
