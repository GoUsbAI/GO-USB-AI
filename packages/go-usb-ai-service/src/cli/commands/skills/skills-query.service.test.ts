...
function createWorkspace(): string {
  const workspace = mkdtempSync(join(tmpdir(), "go-usb-ai-skills-query-"));
...
describe("SkillsQueryService", () => {
  ...
  it("queries marketplace search, info, and recommendations", async () => {
          ...
          return new Response(JSON.stringify({
            ...
            data: {
              ...
              items: [{
                ...
                install: {
                  kind: "marketplace",
                  spec: "@go-usb-ai/weather",
                  command: "go-usb-ai marketplace skills install weather",
                },
    ...
    expect(search.apiBaseUrl).toBe("https://marketplace-api.go-usb-ai.io");
