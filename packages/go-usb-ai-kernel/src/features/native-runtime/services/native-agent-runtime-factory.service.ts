...
import { DefaultNcpAgentRuntime, type LocalAssetStore } from "@go-usb-ai/ncp-agent-runtime";
import {
...
import { GoUsbAiNcpContextBuilder } from "./go-usb-ai-ncp-context-builder.service.js";
...
export class NativeAgentRuntimeFactory {
  ...
  create: NativeRuntimeFactory = ({
    ...
    const runtime = new DefaultNcpAgentRuntime({
      contextBuilder: new GoUsbAiNcpContextBuilder({
        agentId,
        toolRegistry,
