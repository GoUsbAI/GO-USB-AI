...
import { BUILTIN_PROVIDER_PLUGINS } from "@go-usb-ai/runtime";
import type { NcpAgentRunInput, NcpProviderRuntimeRoute } from "@go-usb-ai/ncp";
import type { RuntimeFactoryParams } from "@go-usb-ai/ncp-toolkit";
import {
  HttpRuntimeConfigResolver,
  HttpRuntimeNcpAgentRuntime,
} from "@go-usb-ai/go-usb-ai-ncp-runtime-http-client";
import {
  probeStdioRuntime,
  StdioRuntimeConfigResolver,
  StdioRuntimeNcpAgentRuntime,
} from "@go-usb-ai/go-usb-ai-ncp-runtime-stdio-client";
import type {
  AgentRuntimeEntry,
