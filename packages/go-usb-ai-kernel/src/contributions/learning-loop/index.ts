...
import { NcpEventType, type NcpEndpointEvent, type NcpMessage } from "@go-usb-ai/ncp";
import { eventKeys, type Unsubscribe } from "@go-usb-ai/shared";
...
export class LearningLoopContribution implements KernelContribution {
  ...
  constructor(private readonly kernel: GoUsbAiKernel) {
