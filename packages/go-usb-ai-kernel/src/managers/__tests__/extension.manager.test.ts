...
import type { PluginChannelBinding, PluginRegistry } from "@go-usb-ai/openclaw-compat";
...
function createTempDir(): string {
  const dir = mkdtempSync(join(tmpdir(), "go-usb-ai-kernel-extension-manager-test-"));
  tempDirs.push(dir);
  return dir;
}
