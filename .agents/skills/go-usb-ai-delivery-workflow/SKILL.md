---
name: go-usb-ai-delivery-workflow
...
- `go-usb-ai-clean-implementation`
- `predictable-behavior-first`
- `go-usb-ai-validation-workflow`
- `post-edit-maintainability-guard`
- `post-edit-maintainability-review`
- `go-usb-ai-iteration-log-governance`
- `learning-from-failures`
- 当复盘结论涉及治理系统时，用 `go-usb-ai-agent-instructions-governance`
...
进入编辑前，必须先过 `go-usb-ai-clean-implementation`。
...
改完后使用 `go-usb-ai-validation-workflow`。
...
- `go-usb-ai-agent-instructions-governance`

### 7. 迭代留痕决策

收尾阶段必须使用 `go-usb-ai-iteration-log-governance` 判断是否需要 `docs/logs`。
