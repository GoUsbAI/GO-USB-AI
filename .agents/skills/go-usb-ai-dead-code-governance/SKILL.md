---
name: go-usb-ai-dead-code-governance
description: 当用户要求扫描、识别、清理、常态化治理 GoUsbAi 仓库里的死代码、无用代码、unused files、unused exports、unused dependencies，尤其是核心包越来越臃肿、想删旧实现或做定期减债时使用。
---
