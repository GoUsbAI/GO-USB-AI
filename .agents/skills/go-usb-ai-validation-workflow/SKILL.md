---
name: go-usb-ai-validation-workflow
...
- Prefer the package-level lint command for the touched package, for example `pnpm --filter go-usb-ai lint`.
...
Before code edits, use `go-usb-ai-clean-implementation` and explicitly check:
