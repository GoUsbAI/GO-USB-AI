---
name: go-usb-ai-agent-instructions-governance
...
# GoUsbAi Agent Instructions Governance
...
- If the change is a large rules restructure, token optimization, or skill migration, use `go-usb-ai-iteration-log-governance` at the end to decide whether to create or update a `docs/logs` entry.
